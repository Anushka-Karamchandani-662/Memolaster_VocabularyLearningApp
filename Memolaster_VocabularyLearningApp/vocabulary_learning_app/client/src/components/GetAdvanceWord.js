...
function GetAdvanceWord() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3001/get-advance")
      .then((res) => {
  ...
  const handleAddToCart = (productId) => {
    ...
    axios
      .post("http://localhost:3001/add-to-advance", _data)
      .then((res) => {
  ...
  return (
    <div>
      ...
      <Link to={"/get/intermediate"}>intermediate</Link>
    </div>
  );
}

export default GetAdvanceWord;
